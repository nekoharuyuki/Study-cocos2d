...
PuzzlePage::PuzzlePage() {
    ...
    // 全ての端末で画面サイズを640*1136にする
    glview->setFrameSize(640, 1136);
    glview->setDesignResolutionSize(glview->getFrameSize().width, glview->getFrameSize().height, ResolutionPolicy::FIXED_WIDTH);
...
bool GameLayer::init(int level)
{
    ...
    FileUtils::getInstance()->addSearchPath("TestProjects/Puzzle");
